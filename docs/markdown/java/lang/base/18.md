...
![4428b288361296048](/java/lang/base/18/4428b288361296048.png)

### 1.4 各版本介绍

![jdkxintexing](/java/lang/base/18/jdkxintexing.jpg)
...
<img src="/java/lang/base/18/image-20220525200441935.png" alt="image-20220525200441935" style="zoom:80%;" />

> 链接：https://pan.baidu.com/s/15QrBUOvfE9vjlTzN_EeVLg 
> 提取码：yyds 

![image-20221213235332866](/java/lang/base/18/image-20221213235332866.png)
...
<img src="/java/lang/base/18/image-20220525201653599.png" alt="image-20220525201653599" style="zoom:80%;" />
...
<img src="/java/lang/base/18/lambda表达式.jpg" alt="lambda表达式" style="zoom:67%;" />

![image-20221111213355625](/java/lang/base/18/image-20221111213355625.png)
...
<img src="/java/lang/base/18/image-20220527101737072.png" alt="image-20220527101737072" style="zoom:67%;" />

- 从匿名类到 Lambda 的转换举例2

<img src="/java/lang/base/18/image-20220527101814203.png" alt="image-20220527101814203" style="zoom:80%;" />
...
<img src="/java/lang/base/18/image-20220527103215741.png" alt="image-20220527103215741" style="zoom:67%;" />
...
![](/java/lang/base/18/03-Overview.png)
...
<img src="/java/lang/base/18/image-20220527111442115.png" alt="image-20220527111442115" style="zoom: 80%;" />

举例2：

<img src="/java/lang/base/18/image-20220527111621424.png" alt="image-20220527111621424" style="zoom:80%;" />

作为参数传递 Lambda 表达式：

<img src="/java/lang/base/18/image-20220527111751485.png" alt="image-20220527111751485" style="zoom:80%;" />
...
（2）添加n个员工对象到一个`HashMap<Integer,Employee>`集合中，其中员工编号为key，员工对象为value。
...
<img src="/java/lang/base/18/image-20220514180803311.png" alt="image-20220514180803311" style="zoom: 50%;" />
...
- 调出jShell
 ...
 ![image-20220527205410620](/java/lang/base/18/image-20220527205410620.png)

- 获取帮助


 ![image-20220527205418073](/java/lang/base/18/image-20220527205418073.png)

- 基本使用


 ![image-20220527205429720](/java/lang/base/18/image-20220527205429720.png)

- 导入指定的包


 ![image-20220527205440068](/java/lang/base/18/image-20220527205440068.png)

- 默认已经导入如下的所有包：（包含java.lang包）


 ![image-20220527205445267](/java/lang/base/18/image-20220527205445267.png)

- 只需按下 Tab 键，就能自动补全代码


 ![image-20220527205451352](/java/lang/base/18/image-20220527205451352.png)

- 列出当前 session 里所有有效的代码片段


 ![image-20220527205458774](/java/lang/base/18/image-20220527205458774.png)

- 查看当前 session 下所有创建过的变量


 ![image-20220527205506632](/java/lang/base/18/image-20220527205506632.png)

- 查看当前 session 下所有创建过的方法


 ![image-20220527205513459](/java/lang/base/18/image-20220527205513459.png)
...
- 使用外部代码编辑器来编写 Java 代码
 ...
 ![image-20220527205519915](/java/lang/base/18/image-20220527205519915.png)
...
- 使用/open命令调用
 ...
 ![image-20220527205827712](/java/lang/base/18/image-20220527205827712.png)

- 退出jShell


 ![image-20220527205904000](/java/lang/base/18/image-20220527205904000.png)
...
声明一个成员变量，并初始化值为null
 ...
 ![image-20220528155628337](/java/lang/base/18/image-20220528155628337.png)

声明一个数组变量，并为数组静态初始化（省略new的情况下）

 ![image-20220528155436304](/java/lang/base/18/image-20220528155436304.png)

没有初始化的方法内的局部变量声明

 ![image-20220528155525774](/java/lang/base/18/image-20220528155525774.png)

方法的返回值类型

 ![image-20220528155537713](/java/lang/base/18/image-20220528155537713.png)

方法的参数类型

 ![image-20220528155549303](/java/lang/base/18/image-20220528155549303.png)

构造器的参数类型

 ![image-20220528155614708](/java/lang/base/18/image-20220528155614708.png)

作为catch块中异常类型

 ![image-20220528155640498](/java/lang/base/18/image-20220528155640498.png)

Lambda表达式中函数式接口的类型

 ![image-20220528155423180](/java/lang/base/18/image-20220528155423180.png)

方法引用中函数式接口的类型

 ![image-20220528155429055](/java/lang/base/18/image-20220528155429055.png)
...
![image-20220527233322495](/java/lang/base/18/image-20220527233322495.png)
...
![image-20220528212254705](/java/lang/base/18/image-20220528212254705.png)
...
![image-20220528212323729](/java/lang/base/18/image-20220528212323729.png)
...
![image-20220528212414676](/java/lang/base/18/image-20220528212414676.png)

![image-20220528212421319](/java/lang/base/18/image-20220528212421319.png)
