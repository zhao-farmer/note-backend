...
<img src="/java/lang/base/15/image-20220412215446368.png" alt="image-20220412215446368" style="zoom:80%;" />
...
![image-20220412224132724](/java/lang/base/15/image-20220412224132724.png)

### 2.1 Java IO原理

- Java程序中，对于数据的输入/输出操作以“`流(stream)`” 的方式进行，可以看做是一种数据的流动。

  <img src="/java/lang/base/15/image-20220503123117300.png" alt="image-20220503123117300" style="zoom: 80%;" />
...
![image-20220412224700133](/java/lang/base/15/image-20220412224700133.png)
...
- 根据IO流的角色不同分为：**节点流**和**处理流**。
  - **节点流**：直接从数据源或目的地读写数据
    ...
    ![image-20220412230745170](/java/lang/base/15/image-20220412230745170.png)

  - **处理流**：不直接连接到数据源或目的地，而是“连接”在已存在的流（节点流或处理流）之上，通过对数据的处理为程序提供更为强大的读写功能。

    ![image-20220412230751461](/java/lang/base/15/image-20220412230751461.png)

小结：图解

<img src="/java/lang/base/15/image-20220412225253349.png" alt="image-20220412225253349" style="zoom:67%;" />
...
![image-20220412230501953](/java/lang/base/15/image-20220412230501953.png)
...
![image-20220518095907714](/java/lang/base/15/image-20220518095907714.png)
...
提示：
 ...
 ![image-20220413002723838](/java/lang/base/15/image-20220413002723838.png)
...
![image-20220413002314063](/java/lang/base/15/image-20220413002314063.png)



<img src="/java/lang/base/15/image-20220514183413011.png" alt="image-20220514183413011" style="zoom:80%;" />
...
<img src="/java/lang/base/15/2_zhuanhuan.jpg" style="zoom: 67%;" />

具体来说：

<img src="/java/lang/base/15/image-20220412231533768.png" alt="image-20220412231533768" style="zoom:85%;" />
...
![image-20220525164636164](/java/lang/base/15/image-20220525164636164.png)

- 小结

![字符集](/java/lang/base/15/字符集.jpg)
...
<img src="/java/lang/base/15/image-20220503123328452.png" alt="image-20220503123328452" style="zoom:67%;" />
...
<img src="/java/lang/base/15/3_xuliehua.jpg" style="zoom:70%;" />
...
<img src="/java/lang/base/15/image-20220503123603551.png" alt="image-20220503123603551" style="zoom:80%;" />
...
<img src="/java/lang/base/15/image-20220412232254819.png" alt="image-20220412232254819" style="zoom:80%;" />
...
- 打印流：`PrintStream`和`PrintWriter`
  - 提供了一系列重载的print()和println()方法，用于多种数据类型的输出
    ...
    ![image-20220131021502089](/java/lang/base/15/image-20220131021502089.png)

    ![image-20220131021528397](/java/lang/base/15/image-20220131021528397.png)
...
- 在导入commons-io-2.5.jar包之后，内部的API都可以使用。
 ...
 ![image-20220416004246436](/java/lang/base/15/image-20220416004246436.png)
