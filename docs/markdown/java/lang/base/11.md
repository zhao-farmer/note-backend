...
- String对象的字符内容是存储在一个字符数组value[]中的。`"abc"` 等效于 `char[] data={'h','e','l','l','o'}`。
  ...
  <img src="/java/lang/base/11/image-20220514184404024.png" alt="image-20220514184404024" style="zoom:80%;" />
...
![image-20220405160036240](/java/lang/base/11/1562945799274.png)
...
<img src="/java/lang/base/11/image-20220405152839525.png" alt="image-20220405152839525" style="zoom:67%;" />

进一步：

<img src="/java/lang/base/11/image-20220405152941599.png" alt="image-20220405152941599" style="zoom:67%;" />
...
<img src="/java/lang/base/11/image-20220405153027693.png" alt="image-20220405153027693" style="zoom:67%;" />

#### 1.2.3 练习类型2：new

String str1 = “abc”; 与 String str2 = new String(“abc”);的区别？

<img src="/java/lang/base/11/image-20220405160149200.png" alt="image-20220405160149200" style="zoom:67%;" />
...
<img src="/java/lang/base/11/image-20220405160321172.png" alt="image-20220405160321172" style="zoom:67%;" />
...
- java.lang.StringBuffer代表`可变的字符序列`，JDK1.0中声明，可以对字符串内容进行增删，此时不会产生新的对象。比如：
  ...
  ![image-20220405221714261](/java/lang/base/11/image-20220405221714261.png)

<img src="/java/lang/base/11/image-20220228153030902.png" alt="image-20220228153030902" style="zoom:80%;" />


- 继承结构：


 ![image-20220405174233055](/java/lang/base/11/image-20220405174233055.png)

 <img src="/java/lang/base/11/image-20220405174414780.png" alt="image-20220405174414780" style="zoom:67%;" />
...
>
>    ![image-20220405223542750](/java/lang/base/11/image-20220405223542750.png)
...
![1572599023197](/java/lang/base/11/1572599023197.png)
...
<img src="/java/lang/base/11/image-20220511105252261.png" alt="image-20220511105252261" style="zoom:67%;" />
...
- 获取Calendar实例的方法
  ...
  - 使用`Calendar.getInstance()`方法
    ...
    ![image-20220123184906903](/java/lang/base/11/image-20220123184906903.png)

  - 调用它的子类GregorianCalendar（公历）的构造器。

    ![image-20220405225828816](/java/lang/base/11/image-20220405225828816.png)
...
- 常用字段
  ...
  ![1620277709044](/java/lang/base/11/1620277709044.png)
...
<img src="/java/lang/base/11/image-20220503120722810.png" alt="image-20220503120722810" style="zoom:67%;" />
...
![image-20220406000442908](/java/lang/base/11/image-20220406000442908.png)
...
![image-20220406001726285](/java/lang/base/11/image-20220406001726285.png)
...
- 成员方法
  ...
  - `String getProperty(String key)`：
    ...
    ![image-20220406003340258](/java/lang/base/11/image-20220406003340258.png)
