...
![](/java/lang/base/02/015.png)

![](/java/lang/base/02/016.png)
...
2.  初识变量
    ...
    - 变量的概念：
        ...
        ![](/public/java/lang/base/02/017.png)
...
- 步骤2：变量的赋值
    ...
    **变量赋值的语法格式：**
    ...
    <img src="/java/lang/base/02/019.png" alt="image-20220514152216148" style="zoom: 80%;" />
...
<img src="/java/lang/base/02/020.png" alt="image-20220311001553945" style="zoom:80%;" />
...
![](/java/lang/base/02/023.png)

基本数据类型的转换规则如图所示：

![](/java/lang/base/02/022.png)
...
<img src="/java/lang/base/02/024.png" alt="image-20220523162407722" style="zoom:67%;" />
...
<img src="/java/lang/base/02/025.png" alt="010101" style="zoom: 33%;" />
...
<img src="/java/lang/base/02/026.png" alt="image-20220520105721126" style="zoom:67%;" />

记忆技巧：

<img src="/java/lang/base/02/027.png" alt="morsecode" style="zoom:50%;" />

我们偶尔会看到的：SOS，即为：

![](/java/lang/base/02/028.png)
...
<img src="/java/lang/base/02/030.png" alt="image-20220312000042595" style="zoom:67%;" />

### 6.6 二进制与八进制、十六进制间的转换

**二进制转八进制**

<img src="/java/lang/base/02/031.png" alt="image-20220312000233863" style="zoom:80%;" />

**二进制转十六进制**

<img src="/java/lang/base/02/032.png" alt="image-20220312000251113" style="zoom:80%;" />

**八进制、十六进制转二进制**

<img src="/java/lang/base/02/033.png" alt="image-20220312000341297" style="zoom: 67%;" />

### 6.7 各进制间的转换

<img src="/java/lang/base/02/034.png" alt="image-20220312000143438" style="zoom:80%;" />
...
#### 7.4.1 基本语法
![]()
<img src="/java/lang/base/02/037.png" alt="image-20220312001943403" style="zoom: 67%;" />
...
<img src="/java/lang/base/02/038.png" alt="" style="zoom:75%;" />

<img src="/java/lang/base/02/039.png" alt="" style="zoom:67%;" />
...
![](/java/lang/base/02/040.png)

```java
-3<<4  类似于  -3*2的4次幂 => -3*16 => -48
```

![](/java/lang/base/02/041.png)
...
![](/java/lang/base/02/042.png)

```
-69>>4  类似于  -69/2的4次 = -69/16 = -5
```

![](/java/lang/base/02/043.png)
...
![](/java/lang/base/02/044.png)

```
-69>>>4   结果：268435451
```

![](/java/lang/base/02/045.png)
...
![](/java/lang/base/02/046.png)

```java
-9 & 7 = 7
```

![](/java/lang/base/02/047.png)
...
![](/java/lang/base/02/048.png)

```java
-9 | 7 //结果： -9
```

![](/java/lang/base/02/049.png)
...
![](/java/lang/base/02/050.png)

```java
-9 ^ 7 //结果为-16
```

![](/java/lang/base/02/051.png)
...
![](/java/lang/base/02/052.png)

```java
~-9  //结果：8
```

![](/java/lang/base/02/053.png)

#### 7.5.2 举例

**举例1：**

<img src="/java/lang/base/02/054.png" alt="" style="zoom: 67%;" />

**举例2：体会 m = k ^ n = (m ^ n) ^ n**

<img src="/java/lang/base/02/055.png" alt="" style="zoom:67%;" />
...
- 说明：条件表达式是boolean类型的结果，根据boolean的值选择表达式1或表达式2
  ...
  <img src="/java/lang/base/02/056.png" alt="" style="zoom:67%;" />
...
![](/java/lang/base/02/058.png)


### 8.7 小结

![](/java/lang/base/02/059.png)
