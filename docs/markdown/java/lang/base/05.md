...
<img src="/java/lang/base/05/snipaste_20220317_000101.jpg" alt="snipaste_20220317_000101" style="zoom: 50%;" />
...
![image-20220317000952499](/java/lang/base/05/image-20220317000952499.png)
...
![image-20211221164709624](/java/lang/base/05/image-20211221164709624.png)
...
![](/java/lang/base/05/1561509460135.png)
...
![JVM架构-简图](/java/lang/base/05/JVM架构-简图.png)
...
<img src="/java/lang/base/05/数组内存图2.jpg" style="zoom:67%;" />
...
```
 ...
 <img src="/java/lang/base/05/数组内存图3.jpg" style="zoom:67%;" />
...
<img src="/java/lang/base/05/image-20220317004637748.png" alt="image-20220317004637748" style="zoom:80%;" />
...
- 如果说可以把一维数组当成几何中的`线性图形`，那么二维数组就相当于是`一个表格`，像Excel中的表格、围棋棋盘一样。
  ...
  <img src="/java/lang/base/05/image-20220317004810263.png" alt="image-20220317004810263" style="zoom:80%;" />
...
```
  ...
  ![image-20220516095701345](/java/lang/base/05/image-20220516095701345.png)

蓝框的几个元素，可以使用一维数组来存储。但现在发现每个元素下还有下拉框，其内部还有元素，那就需要使用二维数组来存储：

  ![image-20220516095829526](/java/lang/base/05/image-20220516095829526.png)

- 使用说明

  ![1561524724397](/java/lang/base/05/1561524724397-1647707344971.png)
...
![1562112672215](/java/lang/base/05/1562112672215.png)
...
![1562113179785](/java/lang/base/05/1562113179785.png)
...
![1562113981079](/java/lang/base/05/1562113981079.png)
...
![image-20220317005436209](/java/lang/base/05/image-20220317005436209.png)
...
![image-20220317005549522](/java/lang/base/05/image-20220317005549522.png)
...
![1574577970893](/java/lang/base/05/1574577970893.png)
...
<img src="/java/lang/base/05/snipaste_20220317_225346.jpg" alt="snipaste_20220317_225346" style="zoom:80%;" />![snipaste_20220317_225359](/java/lang/base/05/snipaste_20220317_225359.jpg)
...
![1659199523932](/java/lang/base/05/1659199523932.png)
...
<img src="/java/lang/base/05/image-20221117195931777.png" alt="image-20221117195931777" style="zoom:67%;" />
...
![1561469087319](/java/lang/base/05/1561469087319.png)
...
![image-20220317230955644](/java/lang/base/05/image-20220317230955644.png)

实现步骤：

<img src="/java/lang/base/05/image-20220623210601915.png" alt="image-20220623210601915" style="zoom:67%;" />
...
- **衡量排序算法的优劣：**
  ...
  - `稳定性`：若两个记录A和B的关键字值相等，但排序后A、B的先后次序保持不变，则称这种排序算法是稳定的。
    ...
    ![image-20211222113701365](/java/lang/base/05/image-20211222113701365.png)
...
![image-20211222111142684](/java/lang/base/05/image-20211222111142684.png)
...
![image-20220824003440106](/java/lang/base/05/image-20220824003440106.png)

#### 6.6.3 冒泡排序（Bubble Sort）

<img src="/java/lang/base/05/image-20220516094637228.png" alt="image-20220516094637228" style="zoom:67%;" />
...
![BubbleSort](/java/lang/base/05/BubbleSort.png)
...
![image-20220317235922776](/java/lang/base/05/image-20220317235922776.png)

图示2：

第一轮操作：

![image-20221117205612230](/java/lang/base/05/image-20221117205612230.png)

第二轮操作：

![image-20221117205719427](/java/lang/base/05/image-20221117205719427.png)
...
![](/java/lang/base/05/空指针异常-1647708157677.jpg)

**空指针异常在内存图中的表现**

![1572338767825](/java/lang/base/05/1572338767825-1647708157678.png)
