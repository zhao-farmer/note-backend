...
<img src="/java/lang/base/10/c3dcb61e3b.png" alt="c3dcb61e3b" style="zoom:50%;" />
...
* **线程（thread）**：进程可进一步细化为线程，是程序内部的`一条执行路径`。一个进程中至少有一个线程。
  ...
  - 一个进程同一时间若`并行`执行多个线程，就是支持多线程的。
    ...
    <img src="/java/lang/base/10/image-20220331233204504.png" alt="image-20220331233204504" style="zoom:67%;" />
  ...
  <img src="/java/lang/base/10/image-20220514175737426.png" alt="image-20220514175737426" style="zoom:80%;" />
...
<img src="/java/lang/base/10/进程概念.png" style="zoom:80%;" />

2、一个应用程序的多次运行，就是多个进程

<img src="/java/lang/base/10/1563267431480.png" alt="1563267431480" style="zoom:80%;" />

3、一个进程中包含多个线程

<img src="/java/lang/base/10/1563270525077.png" alt="1563270525077" style="zoom:80%;" />
...
- **抢占式调度**
  ...
  ![抢占式调度](/java/lang/base/10/抢占式调度.bmp)
...
* **并行（parallel）**：指两个或多个事件在`同一时刻`发生（同时发生）。指在同一时刻，有`多条指令`在`多个CPU`上`同时`执行。比如：多个人同时做不同的事。
  ...
  ![image-20220401000804242](/java/lang/base/10/image-20220401000804242.png)

  <img src="/java/lang/base/10/image-20220513181758585.png" alt="image-20220513181758585" style="zoom: 50%;" />

* **并发（concurrency）**：指两个或多个事件在`同一个时间段内`发生。即在一段时间内，有`多条指令`在`单个CPU`上`快速轮换、交替`执行，使得在宏观上具有多个进程同时执行的效果。

  ![image-20220401000515678](/java/lang/base/10/image-20220401000515678.png)
  
  <img src="/java/lang/base/10/image-20220513181815978.png" alt="image-20220513181815978" style="zoom:50%;" />
...
<img src="/java/lang/base/10/image-20220401221215860.png" alt="image-20220401221215860" style="zoom:67%;" />
...
<img src="/java/lang/base/10/image-20220401222212377.png" alt="image-20220401222212377"  />
...
<img src="/java/lang/base/10/image-20220401002307038.png" alt="image-20220401002307038" style="zoom: 67%;" />
...
![image-20220524203355448](/java/lang/base/10/image-20220524203355448.png)

或

![线程的生命周期Thread.State](/java/lang/base/10/线程的生命周期Thread.State.jpg)
...
![image-20220524195035355](/java/lang/base/10/image-20220524195035355.png)
...
<img src="/java/lang/base/10/image-20220401233218326.png" alt="image-20220401233218326" style="zoom:67%;" />



类比：

![](/java/lang/base/10/当我以为我的代码很安全时，等等.gif)
...
![1563372934332](/java/lang/base/10/1563372934332.png)
...
![thread-lock](/java/lang/base/10/thread-lock.png)
...
![线程池的理解](/java/lang/base/10/线程池的理解.jpg)
