 Day08【线程状态、volatile关键字、原子性、并发包、死锁、线程池】 
...
![](/java/lang/advance/073.png)

### 2.3. 问题分析

![](/java/lang/advance/074.png)
...
![](/java/lang/advance/078.png)

2. 此时线程1想要把变量的值增加1。对线程1来说，旧的预期值A=10，要修改的新值B=11。

![](/java/lang/advance/079.png)

3. 在线程1要提交更新之前，另一个线程2抢先一步，把内存地址V中的变量值率先更新成了11。

![](/java/lang/advance/080.png)

4. 线程1开始提交更新，首先进行A和地址V的实际值比较（Compare），发现A不等于V的实际值，提交失败。

![](/java/lang/advance/081.png)

5. 线程1重新获取内存地址V的当前值，并重新计算想要修改的新值。此时对线程1来说，A=11，B=12。这个重新尝试的过程被称为自旋。

![](/java/lang/advance/082.png)

6. 这一次比较幸运，没有其他线程改变地址V的值。线程1进行Compare，发现A和地址V的实际值是相等的。

![](/java/lang/advance/083.png)

7. 线程1进行SWAP，把地址V的值替换为B，也就是12。

![](/java/lang/advance/084.png)
...
1. 假死：
    ...
    ![](/java/lang/advance/085.png)

2. 异常：

    ![](/java/lang/advance/086.png)

3. 错误结果：


    ![](/java/lang/advance/087.png)
...
![](/java/lang/advance/090.png)

**ConcurrentHashMap高效的原因：CAS + 局部(synchronized)锁定**分段式锁


![](/java/lang/advance/091.png)
